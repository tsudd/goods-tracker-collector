...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoodsTracker.DataCollector.DB.Entities.ItemError", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_item_errors");

                    b.HasIndex("StreamId")
                        .HasDatabaseName("ix_item_errors_stream_id");

                    b.ToTable("item_errors", (string)null);
                });
            ...
            modelBuilder.Entity("GoodsTracker.DataCollector.DB.Entities.ItemError", b =>
                {
                    b.HasOne("GoodsTracker.DataCollector.DB.Entities.Stream", "Stream")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_item_errors_streams_stream_id");
